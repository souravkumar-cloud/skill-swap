...
```bash
git clone https://github.com/souravkumar-cloud/skill-swap.git
cd skill-swap
```
...
- [Geist Font](https://vercel.com/font) - Optimized font family by Vercel
...
This project uses [`next/font`](https://nextjs.org/docs/app/building-your-application/optimizing/fonts) to automatically optimize and load Geist, a custom font family for Vercel.
